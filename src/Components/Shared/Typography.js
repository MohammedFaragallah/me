import { Link, Typography as MuiTypography } from '@material-ui/core';
...
const injectColor = color => colors.includes(color) && { color };

const displays = ['initial', 'inline', 'block'];

const injectDisplay = display =>
	displays.includes(display) ? display : undefined;
	...
	return {
		root: {
			...
			...createStylesBySize(
				...
				[
					['none', '0px !important'],
					['small', { xs: spacing(1), md: spacing(1) }],
