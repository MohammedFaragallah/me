...
const loaderSizes = { small: 16, big: 28, large: 36 };

const getLoaderSize = size => loaderSizes[size] || 20;

const colors = ['default', 'inherit', 'primary', 'secondary'];

const injectColor = color =>
	colors.includes(color) ? { color } : { style: { color } };
